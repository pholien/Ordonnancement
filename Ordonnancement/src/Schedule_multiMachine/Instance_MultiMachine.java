...
public class Instance_MultiMachine {
	...
	public static List<List> genererInstance(String filename) {
		...
		try {
            ...
            out.write("data;\r\n");
            out.write("param nombreTypeRessource := " + k + ";\r\n");
            out.write("param nombreJob := " + nbJob + ";\r\n");
            out.write("param job duree :=");
            for(int i = 0; i < nbJob; i++){
            ...
            out.write("param nombreMachine := " + nbMachine + ";\r\n");
            ...
            for(int i = 0; i < nbMachine; i++){
            	out.write("    " + "    " + "    " + "    " + "    ");
            	String idMachine = Integer.toString(i+1);
            	out.write(idMachine);
            	out.write("    ");
            	for(int j = 0; j < k; j++){
            		out.write(" " + listMachine.get(i).getRessources().get(j));  
                }
            	if(i == nbJob - 1)
            		out.write(";");
            	out.write("\r\n");
